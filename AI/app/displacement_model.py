...
def train_displacement_and_evaluate(training_dataset,validation_dataset,testing_dataset):
    find_and_use_GPU()
    all_data=prepare_dataset(training_dataset,testing_dataset)
    cv_scores = []
    all_true_labels = []
    all_predictions = []
    fold_histories = []
    ...
    print("Processing sequences...",X,y)
    n_splits = 5
